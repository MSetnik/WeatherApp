...
public class CurrentWeatherFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        currentWeatherViewModel.GetCurrentWeather().observe(getActivity(), currentWeather -> {
    ...
    private void BindWeatherData(CurrentWeather currentWeather, View view) {
        ...
        temperature.setText(Math.round(currentWeather.getMain().getTemp())+ getString(R.string.celsius_symbol));
        feelsLike.setText(Math.round(currentWeather.getMain().getFeelsLike()) + getString(R.string.celsius_symbol));
        tempMin.setText(Math.round(currentWeather.getMain().getTempMin()) + getString(R.string.celsius_symbol) );
        tempMax.setText(Math.round(currentWeather.getMain().getTempMax())+ getString(R.string.celsius_symbol));
        humidity.setText(currentWeather.getMain().getHumidity() + getString(R.string.humidity_symbol));
        pressure.setText(currentWeather.getMain().getPressure() + " " +getString(R.string.pressure_symbol));
